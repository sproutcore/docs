...
JSDOC.Symbol.prototype.setTags = function() {
	...
	*/
	...
	/*t:
		var sym = new JSDOC.Symbol("foo", [], "FILE", new JSDOC.DocComment("/**@readonly*"+"/"));
		is(sym.isReadonly, true, "@readonly tag, isReadonly set.");
	*/
	...
	*/
	...
	if (singletons.length) {
		this.classDesc = singletons[0].desc;
		this.isSingleton = true;
	}

	/*t:
		var sym = new JSDOC.Symbol("foo", [], "OBJECT", new JSDOC.DocComment("/**@singleton This describes the singleton.*"+"/"));
		is(sym.classDesc, "This describes the singleton.", "@singleton tag, class description is found.");
	*/
