...
function  saveDashIndex( classes, conf )
{
  ...
  var cmd = "cat " + conf.rootDir + "index.sql | sqlite3 " + conf.rootDir + conf.bundleRef +
            "/Resources/docSet.dsidx; tar -C " + conf.rootDir + " --exclude='.DS_Store' -cvzf " +
            conf.rootDir + "/sproutcore.tgz sproutcore.docset"
